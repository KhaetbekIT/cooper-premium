...
<table cellpadding="6" cellspacing="0">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Камеры глубины<br/>HD-камеры</td>
      <td>Камеры глубины<br/>HD-камеры<br/>32-линейный 3D LiDAR</td>
      <td>Камеры глубины<br/>HD-камеры<br/>32-линейный 3D LiDAR</td>
      <td>Камеры глубины<br/>HD-камеры</td>
      <td>Камеры глубины<br/>HD-камеры<br/>32-линейный 3D LiDAR</td>
      <td>Камеры глубины<br/>HD-камеры<br/>32-линейный 3D LiDAR</td>
...
`,
	},
	{
		...
		short_description:
			"Две версии робособаки: AIR — базовая, PRO — с 3D-лидаром, голосовым управлением и eSIM.",
